                ...
                <div class="tabs-container">
                    <div class="tabs-block">
                        <div id="tabs-section" class="tabs">
                            <ul class="tab-head">
                                <li>
                                    <a @click="switchTab(1)" :class="{ active: activeTab === 1 }" class="tab-link"> <span
                                            class="material-icons tab-icon">face</span> <span class="tab-label">Discount
                                            Managament</span></a>
                                </li>
                                <li>
                                    <a @click="switchTab(2)" :class="{ active: activeTab === 2 }" class="tab-link">
                                         <span class="fa fa-user" style="font-size: 22px;"></span>
                                        <span class="tab-label">User Account</span></a>
                                </li>
                                <li>
                                    <a @click="switchTab(3)" :class="{ active: activeTab === 3 }" class="tab-link"> <span
                                            class="material-icons tab-icon">settings_input_hdmi</span> <span
                                            class="tab-label">Settings</span></a>
                                </li>
                                <li>
                                    <a @click="switchTab(4)" :class="{ active: activeTab === 4 }" class="tab-link"> <span
                                            class="material-icons tab-icon">build</span>
                                        <span class="tab-label">Subscription</span></a>
                                </li>
                                <li>

                                    <a v-on:click="logout()" :class="{ active: activeTab === 5 }" class="tab-link"> <span
                                            class="material-icons tab-icon">toll</span>
                                        <span class="tab-label">Logout</span></a>
                                </li>
                            </ul>

                            <section v-show="activeTab === 1" class="tab-body entry-content active active-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <button data-toggle="modal" @click="showCouponCode()" data-target="#myModal"
                                            class="btn btn-sm btn-primary ">Create Discount code</button>&nbsp; &nbsp;
                                        <button data-toggle="modal" @click="showCouponCodeDiscount()"
                                            data-target="#myModalDiscount" class="btn btn-sm btn-primary ">Add Registration
                                            Discount </button>
                                    </div>
                                </div>
                                <div class="">
                                    ...
                                    <table class="table table-bordered" style="font-size: 17px;">
                                        ...
                                        <tbody>
                                            <tr v-for="(coupon, index) in coupons" :key="index">
                                                ...
                                                <td>
                                                    <span v-if="coupon.is_active == true"
                                                        :class="coupon.is_active == true ? 'badge badge-success' : 'badge badge-danger'">
                                                        {{ coupon.is_active == true ? 'Active' : 'Disabled' }}
                                                    </span>
                                                    <span v-else
                                                        :class="coupon.is_active === 1 ? 'badge badge-success' : 'badge badge-danger'">
                                                ...
                                                <td>
                                                    ...
                                                    <button data-toggle="modal" data-target="#myModal2"
                                                        class="btn btn-sm btn-primary" @click="confirmDelete(coupon.id)">
                                                        <i class="fa fa-trash"></i>
                                                    </button> &nbsp; &nbsp;
                                                    <button data-toggle="modal" data-target="#editCouponModal"
                            ...
                            <section v-show="activeTab === 2" class="tab-body entry-content active active-content">
                                <div v-if="successMessage" class="alert alert-success">
                                    {{ successMessage }}
                                </div>
                                ...
                                <form class="needs-validation" novalidate @submit.prevent="UpdateUserInfo">

                                    <div class="card col-lg-12">
                                        <div class="">
                                            <h3 class="pt-2 pb-0"><strong>Personal Information</strong></h3>
                                            <hr class="hr_line">
                                            <div class="form-row">
                                                ...
                                                <div class="row pb-2 ">
                                                    <div class="col-md-12 ml-1">
                                                        <button data-toggle="modal" class="btn btn-sm btn-primary">Update
                                                            Account</button>
                                                    </div>
                                            ...
                                            <h3 class="pt-2 pb-0"><strong>Change Password</strong></h3>
                                            <hr class="hr_line">
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                            ...
                                            <div class="row pb-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <button class="btn btn-sm btn-primary" type="submit"
                                                        :disabled="passwordsDoNotMatch">Update
                                                        Password</button>
                                ...
                                <div id="tandpmodal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
                                    aria-labelledby="tandpmodal" aria-hidden="true">
                            ...
                            <section v-show="activeTab === 3" class="tab-body entry-content active active-content">
                                <h2>Coming Soon..</h2>
                            </section>

                            <section v-show="activeTab === 4" class="tab-body entry-content active active-content">
                                <h2>Coming Soon..</h2>
                            </section>

                            <section v-show="activeTab === 5" class="tab-body entry-content active active-content">
                                <h2>Coming Soon..</h2>
                            </section>
                        </div>
                    </div>
                            ...
                            <form method="post" @submit.prevent="createCoupon">
                                ...
                                <div class="container">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="code" id="code" class="form-control"
                                            placeholder="Coupon Code">
                                    </div>
                                    <div class="form-group">
                                        <label for="discount">Discount:</label>
                                        <input type="number" v-model="discount" @input="updateDiscount" id="discount"
                                            class="form-control" min="0" max="100" step="0.01" placeholder="Discount">
                                        <p v-if="showDiscountError" class="text-danger">Discount must be > 0 and &lt;= 100
                                        </p>
                                    </div>

                                    <div class="form-group">
                                        <label for="is_active">Active:</label>
                                        <input type="checkbox" v-model="is_active" id="is_active" class="m-2 pt-2">
                                    </div>
                                </div>
                                <div class="modal-footer">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="container">
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="editedCoupon.code" id="code" class="form-control"
                                        placeholder="Coupon Code">
                                </div>
                                <div class="form-group">
                                    <label for="discount">Discount:</label>

                                    <input type="number" v-model="editedCoupon.discount" @input="updateDiscount"
                                        id="discount" class="form-control" min="0" max="100" step="0.01"
                                ...
                                <div class="form-group">
                                    <label for="is_active">Active:</label>
                                    <input type="checkbox" v-model="editedCoupon.is_active" id="is_active" class="m-2 pt-2">
                                </div>
                               
                            </div>
                            <div class="modal-footer">
                                <button type="submit" @click="saveEditedCoupon"
                                    class="btn btn-sm btn-primary my-2">Update</button>
                                  </div>
                        </div>
                    </div>

                </div>
                <div v-if="showDeleteConfirmation" id="myModal2" class="modal fade show" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
        ...
        <section class="about-holder border-b-l-white bg-light d-none d-md-block">
            <div class="container">
                <ul class="breadcrumb m-0 p-0">
                    <li class="breadcrumb-item"><a href="index.html" title="الرئيسية" class="text-muted">الرئيسية</a></li>
                ...
                <div class="text-left d-none d-md-block">
                    <ul class="list-unstyled list-inline m-0">
                        <li class="list-inline-item mx-1">
                            <div class="font-2x font-3x">70</div><small>عرض</small>
                        </li>
                        <li class="list-inline-item mx-1">
                            <div class="font-2x font-3x">60</div><small>طلب</small>
                        </li>
                    </ul>
                </div>


                <ul class="list-unstyled list-inline d-flex justify-content-between align-items-center dach-links">
                    <li class="px-1">
                        <a href="dashboard.html" class="card small-card active">
                            <div class="card-body">
                    ...
                    <li class="px-1">
                        <a href="dashboard-settings.html" class="card small-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="card animate-box border-b-l-white pb-3">
                            ...
                            <div class="card-body p-4 border-bottom">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span><span class="font-2x font-3x">320</span> <br> <small>مشاهدة</small></span>
                                    <span class="badge shadow text-success"><i class="icofont-long-arrow-up"></i> +24</span>
                                </div>
                                ...
                                <a href="#" title="تكملة ملفك الشخصي" class="btn btn-secondary btn-sm mt-3">تكملة ملفك
                                    الشخصي</a>
                            </div>

                            <div class="card-body p-4 border-bottom">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span><span class="font-2x font-3x">142</span> <br> <small>عروض مرسلة</small></span>
                                    <span class="badge shadow text-success"><i class="icofont-long-arrow-up"></i> +30</span>
                                </div>

                                <a href="#" title="إبحث عن فرصة" class="btn btn-primary btn-sm mt-3">إبحث عن فرصة</a>
                            </div>

                            <div class="card-body p-4 border-bottom">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span><span class="font-2x font-3x">30</span> <br> <small>طلباتي</small></span>
                                    <span class="badge shadow text-danger"><i class="icofont-long-arrow-up"></i> +24</span>
                                </div>

                                <a href="#" title="إضافة طلب" class="d-inline-block text-primary py-1 mt-3"><i
                                        class="fa fa-plus"></i> إضافة طلب</a>
                            </div>

                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span><span class="font-2x font-3x">1200</span> <br> <small>ظهور
                                            للاعلانات</small></span>
                                    <span class="badge shadow text-success"><i class="icofont-long-arrow-up"></i> +90</span>
                                </div>

                                <a href="#" title="إدارة اعلاناتك" class="d-inline-block text-primary py-1 mt-3"><i
                                        class="fa fa-cog"></i> إدارة اعلاناتك</a>
                            </div>
                                ...
                                <div class="item">
                                    <div class="row m-0">
                                        <div class="col-md-7 col-lg-6 text-md-right pt-5 px-0">
                                            ...
                                            <a href="dashboard-settings.html" class="btn btn-primary btn-sm mb-4"
                                                title="ترقية للنسخة المدفوعة"> ترقية للنسخة المدفوعة</a>
                                        </div>
                                        <div class="col-md-5 col-lg-6 py-4 px-0">
                                            <img src="bluebies/images/dashboard-img.png" alt="..." class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 d-none d-md-block text-left">
                                    <ul class="list-inline list-unstyled mt-4 view-btns">
                                        <li class="list-inline-item active"><a href="gridView" title=".."
                                                class="round-icon border-0"><i class="fa fa-th-large"></i></a></li>
                                        <li class="list-inline-item"><a href="listView" title=".."
                                                class="round-icon border-0"><i class="fa fa-bars"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body py-4">
                                                <div>
                                                    ...
                                                    <ul class="list-unstyled list-inline m-0">
                                                        <li class="list-inline-item mx-1">
                                                            <div class="font-2x font-3x">9200</div><small>ريال سعودي</small>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div>
                                                    <img src="bluebies/images/order-logo-2.png" class="order-logo-sm my-2" alt="...">
                                                    <p class="m-0 text-muted"><i class="fa fa-clock ml-1"></i> 14 اغسطس 2019
                                                    </p>
                                                </div>

                                                <div class="border-top">
                                                    <a href="messages.html" class="btn btn-outline-primary"
                                                        title="إرسال رسالة"><i class="far fa-comments ml-1"></i>إرسال
                                                        رسالة</a>
                                                    <a href="#" class="text-muted mt-2 mr-2" title="تحديث"><i
                                                            class="fa fa-pencil-alt ml-1"></i>تحديث</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="contain-filter">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 filter-btns">
                                    <button type="button" class="btn btn-sm" data-filter="all"><i
                                            class="icofont-ghost ml-1"></i>الكل</button>
                                    <button type="button" class="btn btn-sm" data-filter=".food"><i
                                            class="icofont-food-basket ml-1"></i>الاطعمة</button>
                                    <button type="button" class="btn btn-sm" data-filter=".car"><i
                                            class="icofont-car ml-1"></i>السيارات</button>
                                </div>
                                <div class="col-md-6 text-left">
                                    <a href="#" title="إعداد الأهتمامات"><i class="fa fa-cog ml-1"></i>إعداد الأهتمامات</a>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 col-lg-4 mix food">
                                    <div class="animate-box">
                                        <div class="card">
                                            <div class="card-body py-4">
                                                <div class="row">
                                                    <div class="col"><span class="round-icon"><i
                                                                class="fa fa-city"></i></span></div>
                                                    <div class="col text-left">
                                                        <a href="#" title="طلب عرض اسعار"
                                                            class="btn btn-sm btn-outline-light mt-1">طلب عرض اسعار</a>
                                                    </div>
                                                </div>
                                                ...
                                                <ul class="list-unstyled list-inline text-muted">
                                                    <li class="list-inline-item m-0"><i class="icofont-google-map ml-1"></i>
                                                        الرياض</li>
                                                    <li class="list-inline-item mr-2"><i
                                                            class="icofont-clock-time ml-1"></i> <span
                                                            class="d-inline-block"> 14 اغسطس, 2019</span></li>
                                                </ul>

                                                <img src="bluebies/images/order-logo-1.png" alt="logo" class="order-logo">

                                                <a href="order-single.html" title="التفاصيل" class="order-btn"><i
                                                        class="fa fa-chevron-left"></i> التفاصيل</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-md-left animate-box right-in mt-3">
                                <a href="orders.html" class="btn btn-primary mr-2" title="المزيد من الطلبات">المزيد من
                                    الطلبات</a>
                            </div>
                        </div>
                                    ...
                                    <div class="animate-box">
                                        <div class="card">
                                            <div class="card-body py-4">
                                                ...
                                                <ul class="list-unstyled list-inline m-0">
                                                    <li class="list-inline-item mx-1">
                                                        <div class="font-2x font-3x">70</div><small>المشاهدات</small>
                                                    </li>
                                                    <li class="list-inline-item mx-1">
                                                        <div class="font-2x font-3x">60</div><small>العروض</small>
                                                    </li>
                                                </ul>

                                                <a href="#" class="btn btn-outline-primary mt-2"
                                                    title="شاهد تفاصيل العرض">شاهد تفاصيل العرض <i
...
export default {
    ...
    methods: {
        ...
        saveEditedCoupon() {
            ...
            axios.post('/api/update-coupons', {
                ...
                .then(response => {
                    ...
                    const updatedCouponIndex = this.coupons.findIndex(coupon => coupon.id === this.editedCoupon.id);
        ...
        deleteConfirmed() {
            ...
            axios.delete(`/api/delete-coupons/${this.deleteCouponId}`)
                .then(() => {
                    // Remove the deleted record from the coupons array
                    this.coupons = this.coupons.filter(coupon => coupon.id !== this.deleteCouponId);
